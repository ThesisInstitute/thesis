#!/usr/bin/env python3
"""Real Codex CLI transport for recorded, frozen-evidence core experiments.
...
def main() -> int:
    ...
    if "/" in args.codex or "\\" in args.codex:
        parser.error("--codex must be a PATH-resolved command name")
