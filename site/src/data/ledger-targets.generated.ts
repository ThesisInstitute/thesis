...
export const GENERATED_FORECAST_TARGETS = [
  ...
  },
  {
    ...
    observationId: "obs.us.dol.initial_claims.sa.week_2026-09-19",
    country: "US",
    periodLabel: "2026-10-08",
    unit: "thousands",
    resolutionDate: "2026-10-08",
    ...
    resolutionPolicy: "first_print",
    sourceKind: "official_release",
    source: "U.S. Department of Labor Unemployment Insurance Weekly Claims News Release / ALFRED ICSA advance vintage",
    sourceUrl: "https://alfred.stlouisfed.org/graph/alfredgraph.csv?id=ICSA",
    note: "Target registration generated from the recorded thesis.analyst run for US initial claims, week ending 2026-09-19.",
    registeredAt: "2026-09-14T20:23:15Z",
  ...
  },
  {
    ...
    observationId: "obs.dol.eta.continued_claims.sa.week_2026-09-19.first_print",
    country: "US",
    periodLabel: "2026-10-09",
    unit: "millions",
    ...
    source: "U.S. Department of Labor Unemployment Insurance Weekly Claims release, preserved through ALFRED CCSA advance vintage",
    sourceUrl: "https://alfred.stlouisfed.org/graph/alfredgraph.csv?id=CCSA",
    note: "Target registration generated from the recorded thesis.analyst run for US continued claims, week ending 2026-09-19.",
    registeredAt: "2026-09-14T20:23:15Z",
  ...
  },
  {
    ...
    observationId: "obs.bls.cps.employed_people_by_occupation.transportation_material_moving.september_2026.first_print",
    country: "US",
    periodLabel: "2026-10-14",
    unit: "millions",
    resolutionDate: "2026-10-14",
    ...
    source: "BLS Employment Situation Table A-19",
    sourceUrl: "https://www.bls.gov/web/empsit/cpseea19.htm",
    note: "Target registration generated from the recorded thesis.analyst run for CPS transportation/material moving employment, Sep 2026.",
    registeredAt: "2026-09-14T20:23:15Z",
  ...
  },
  {
    ...
    observationId: "obs.abs.labour.employment_change.australia.september_2026.first_print",
    country: "AU",
    periodLabel: "2026-10-28",
    unit: "thousands",
    ...
    source: "Australian Bureau of Statistics Data API, Labour Force LF/M3.3.1599.20.AUS.M",
    sourceUrl: "https://data.api.abs.gov.au/rest/data/LF/M3.3.1599.20.AUS.M?lastNObservations=30&format=jsondata",
    note: "Target registration generated from the recorded thesis.analyst run for Australia Employment Change, September 2026.",
    registeredAt: "2026-09-14T20:23:15Z",
  ...
  {
    kind: "target_registered",
    dataPointId: "us.dol.initial_claims.sa.week_2026-09-26",
    observationId: "obs.us.dol.initial_claims.sa.week_2026-09-26",
    country: "US",
    periodLabel: "week_2026-09-26",
    unit: "thousands",
    resolutionDate: "2026-10-17",
    resolutionSource: "ALFRED graph CSV",
    resolutionSourceUrl: "https://alfred.stlouisfed.org/graph/alfredgraph.csv?id=ICSA",
    resolutionRule: "Preregistered resolver binding. The analyst must supply the precise first-print rule without changing the bound source, field/table, transform, or release policy.",
    resolutionPolicy: "first_print",
    ...
    source: "ALFRED graph CSV",
    sourceUrl: "https://alfred.stlouisfed.org/graph/alfredgraph.csv?id=ICSA",
    note: "Preregistered before forecasting for initial-claims-week-2026-09-26.",
    registrationState: "preregistered",
    registeredAt: "2026-09-20T17:30:51Z",
    targetContentHash: "e0b0ffc3bfe66cd5d9868f88660206e60f4d144ae598047734270e4c64c435eb",
    series: "us.dol.initial_claims.sa",
    period: "week_2026-09-26",
    catalogSlug: "initial-claims-week-2026-09-26",
    valueScale: 0.001,
    sourceBinding: {"adapter":"alfred-fred","allowedHosts":["alfred.stlouisfed.org"],"expectedReleaseWindow":{"end":"2026-10-17","start":"2026-10-13"},"field":"ICSA","releasePolicy":"advance_vintage","sourceSeriesId":"ICSA","sourceUrl":"https://alfred.stlouisfed.org/graph/alfredgraph.csv?id=ICSA","table":"ALFRED graph CSV","transform":{"factor":0.001,"operation":"multiply"}},
    ledgerPinSha: "d77afe26d83827331d633f63bb50575078b11710",
    ledgerPinLineCount: 216,
  },
  {
    ...
    observationId: "obs.dol.eta.continued_claims.sa.week_2026-09-26.first_print",
    country: "US",
    periodLabel: "2026-10-18",
    unit: "millions",
    ...
    resolutionPolicy: "first_print",
    sourceKind: "official_release",
    source: "ALFRED graph CSV for FRED series CCSA, mirroring U.S. DOL ETA Unemployment Insurance Weekly Claims first prints",
    sourceUrl: "https://alfred.stlouisfed.org/graph/alfredgraph.csv?id=CCSA",
    note: "Target registration generated from the recorded thesis.analyst run for US continued claims, week ending 2026-09-26.",
    registeredAt: "2026-09-21T20:29:34Z",
